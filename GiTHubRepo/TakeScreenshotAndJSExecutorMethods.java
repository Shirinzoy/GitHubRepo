...
public class TakeScreenshotAndJSExecutorMethods {
...
//		takeScreenShot("AmazonHomePage2");
	...
	//but we will be collecting locator and use one browser (chrome), but when we execute our test
	//in firefox, we may not be able to click or sendkeys or do some other actions, that is when we need
	//JSExecutor
